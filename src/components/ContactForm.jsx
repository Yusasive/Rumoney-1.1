      ...
      <div class="container px-6 py-12 mx-auto">
        <div class="lg:flex lg:items-center lg:-mx-6">
          <div class="lg:w-1/2 lg:mx-6">
            <h1 class="text-2xl font-semibold text-black60 capitalize lg:text-3xl">
              Need Some Help?
            </h1>
            <p className="text-black60 text-sm font-medium">
              If you have some questions or want to partner, Rumoney staff are
            ...
            <div class="mt-6 space-y-8 md:mt-8">
              <p class="flex items-start -mx-2">
                ...
                <span class="mx-2 font-medium text-black60 truncate w-72 ">
                  Lagos State, Nigeria
                </span>
              </p>
              ...
              <p class="flex items-start -mx-2">
                ...
                <span class="mx-2 text-black60 text-medium font-semibold truncate w-72 ">
                  Email: rumoney@gmail.com
                </span>
              </p>
            </div>

            <div class="mt-6 w-80 md:mt-8">
              <h3 class="text-black60 text-xl font-semibold ">Follow us</h3>

              <div class="flex mt-4 -mx-1.5 ">
                <a
                  class="mx-1.5 text-gray-500 transition-colors duration-300 transform hover:text-rumoney50"
                  target="_blank"
          ...
          <div class="mt-8 lg:w-1/2 lg:mx-6">
            <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl lg:max-w-xl shadow-gray-300/50 dark:shadow-rumoney30/50">
              ...
              <form class="mt-6">
                ...
                <div class="w-full mt-6">
                  ...
                  <textarea
                    class="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-rumoney10 rounded-md md:h-48  dark:text-gray-300  focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
