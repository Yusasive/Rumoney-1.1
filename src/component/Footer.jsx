...
const Footer = () => {
  return (
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid grid-cols gap-x-3 gap-y-8 lg:w-3/5 sm:grid-cols-4">
			...
			<div className="space-y-3">
                ...
                <h3 className="tracki font-medium uppercase dark:text-gray-50">Follow Us</h3>
                <div className="flex justify-start ml-16 sm:ml-12 space-x-4">
					...
					<a rel="noopener noreferrer" target='_blank' href="https://www.twitter.com/Rumoneyng" title="Twitter" className="flex items-center p-1">
					...
					<a rel="noopener noreferrer" target='_blank' href="https://www.linkedin.com/company/rumoneyng/mycompany" title="Instagram" className="flex items-center p-1">
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2023 Rumoney || All rights reserved.</div>
</footer>
  )
}
