  ...
  return (
    <footer className="px-8 divide-y text-lg dark:bg-rumoney110 dark:text-white">
        ...
        <div className="lg:ml-12 lg:w-2/5">
          <Link
            ...
            <span className="self-center">
              <img src={logo} alt="Rumoney" loading="lazy" />
            </span>
          </Link>
        ...
        <div className="grid grid-cols gap-x-3 gap-y-8 lg:w-3/5 sm:grid-cols-4">
          <div className="space-y-3">
            <ul className="space-y-1">
              ...
              <li>
                <Link rel="noopener noreferrer" to="hire-talents">
                  Hire Talents
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link rel="noopener noreferrer" to="/community">
                  Community
                </Link>
              </li>
              <li>
      ...
      <div className="py-6 text-sm text-center dark:text-gray-400">
        © 2023 Rumoney || All rights reserved.
      </div>
    </footer>
  );
};
